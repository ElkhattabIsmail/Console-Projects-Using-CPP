...
void AskAndCorrectQuestionListAnswers(stQuizz& Quizz)
{
    for (short QuestionNumber = 0; QuestionNumber < Quizz.NumberOfQuestions; QuestionNumber++)
    {
        ...
        SetScreenColor(Quizz.QuestionList[QuestionNumber].PlayerAnswer == Quizz.QuestionList[QuestionNumber].CorrectAnswer);
...
stQuizz GetGameDetailsFromUser()
{
    stQuizz Quizz;
    short Level = 0;
    short OpType = 0;
    ...
    cout << "\nChoose Level : EasyLevel = 1, MedLevel = 2, HardLevel = 3, Mix = 4 : ";
    cin >> Level;
    Quizz.QuestionsLevel = (enQuestionsLevel)Level;
    cout << "\nChoose Operation Type : Add = 1, Sub = 2, Mult = 3, Div = 4, MixOp = 5 : ";
    cin >> OpType;
    Quizz.OpType = (enOperationType)OpType;
...
void PlayMathGame()
{
    ...
    {
        system("Cls");
        system("color 0F"); // Black Color screen
        stQuizz Quizz = GetGameDetailsFromUser();
